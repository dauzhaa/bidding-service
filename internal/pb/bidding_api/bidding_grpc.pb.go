...
const (
	BiddingService_PlaceBid_FullMethodName        = "/bidding_api.BiddingService/PlaceBid"
	BiddingService_GetAuctionState_FullMethodName = "/bidding_api.BiddingService/GetAuctionState"
)
...
func (c *biddingServiceClient) GetAuctionState(ctx context.Context, in *GetAuctionStateRequest, opts ...grpc.CallOption) (*GetAuctionStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, BiddingService_GetAuctionState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBiddingServiceServer) GetAuctionState(context.Context, *GetAuctionStateRequest) (*GetAuctionStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAuctionState not implemented")
}
...
func _BiddingService_GetAuctionState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BiddingService_GetAuctionState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
